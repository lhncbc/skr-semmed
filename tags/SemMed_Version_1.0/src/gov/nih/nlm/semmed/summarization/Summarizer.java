			 ...
			 for(Filter filter : filters) {
				...
				for(int i = 0 ; i < tempIn.size(); i++) {
				 ...
				 if(loop == 3) {
					...
					for(int i = 0 ; i < tempIn.size(); i++) {
						APredication ap = tempIn.get(i);
						out4.println(ap.PMID + "\t#" + ap.predicate + "\t#" + ap.subject + "\t#" + ap.subjectSemtype + "\t#" + ap.object + "\t#" + ap.objectSemtype + "\t#" + ap.novelSubject + "\t#" + ap.novelObject);
					}
				 }
				 else if(loop == 5)  {
					for(int i = 0 ; i < tempIn.size(); i++) {
						APredication ap = tempIn.get(i);
						out5.println(ap.PMID + "\t#" + ap.predicate + "\t#" + ap.subject + "\t#" + ap.subjectSemtype + "\t#" + ap.object + "\t#" + ap.objectSemtype + "\t#" + ap.novelSubject + "\t#" + ap.novelObject);
					}
				 }
			 }
			 out1.close();
