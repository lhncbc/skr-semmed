...
public class TreatmentRowFilter implements SingleRowFilter {

	private static TreatmentRowFilter myInstance = new TreatmentRowFilter();

	private TreatmentRowFilter(){}

	public static TreatmentRowFilter getInstance(){
		return myInstance;
	}
