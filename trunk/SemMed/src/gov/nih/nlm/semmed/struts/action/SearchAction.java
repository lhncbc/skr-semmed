...
public class SearchAction extends LookupDispatchAction {
	...
	public ActionForward uploadSemrep(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			String cmd[]={"/ActivePerl/perl/bin/perl", perl1Realpath, "semmedtest", tempSemrepRealpath}; // for shin-pc
			// String cmd[]={"/usr/bin/perl", perl1Realpath, "semmed2006test", tempSemrepRealpath}; // for SKR3
			...
			String cmd2[]={"/ActivePerl/perl/bin/perl", perl2Realpath, "semmedtest"}; // for shin-pc
			// String cmd2[]={"/usr/bin/perl", perl2Realpath, "semmed2006test"}; // for skr3
