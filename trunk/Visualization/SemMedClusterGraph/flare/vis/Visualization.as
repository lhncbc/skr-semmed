package flare.vis
{
	...
	public class Visualization extends Sprite
	{
		...
		{
			// Alert.show('step 1 in update()');
			if (_axes != null) _axes.update(t);
			// Alert.show('step 2 in update()');
			_operators.operate(t);
			// Alert.show('step 3 in update()');
			if (_axes != null) _axes.update(t);
			// Alert.show('step 4 in update()');
			fireEvent(VisualizationEvent.UPDATE, t);
			// Alert.show('step 5 in update()');
			return t;
		}

		public function cleanUpdate(t:Transitioner=null):Transitioner
		{
			fireEvent(VisualizationEvent.UPDATE, t);
			return t;
		}
