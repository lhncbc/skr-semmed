...
public class SearchForm extends ActionForm {
	...
	/** For sampling */
	private String selectedGrantRange;
	private String selectedGrantSize;
	...
	public ActionErrors validate(
		...
		/* } else { // method is null, it happens when user just enter without clicking a botton
...
/*	public void setSelectedSearchType(String selectedSearchType) {
	 ...
	 * @return Returns the uploadFile.
	 */
	public String getSelectedGrantRange() {
		return selectedGrantRange;
	}

	/**
	 * @param uploadFile The uploadFile to set.
	 */
	public void setSelectedGrantRange(String range) {
		this.selectedGrantRange = range;
	}

	/**
	 * @return Returns the uploadFile.
	 */
	public String getSelectedGrantSize() {
		return selectedGrantSize;
	}

	/**
	 * @param uploadFile The uploadFile to set.
	 */
	public void setSelectedGrantSize(String size) {
		this.selectedGrantSize = size;
	}
