...
//				TODO [Alejandro] check the subject/object is novel
	...
	public APredicationList getSubList(String idString) {
		APredicationList subList = new APredicationList();
		// ListIterator<APredication> iter = this.listIterator();
		// APredication apred = null;
		int id = Integer.parseInt(idString);
		// while((apred = (APredication) iter.next()) != null) {
		for(APredication apred : this) {
			if(apred.PMID == id )
				subList.add(apred);
		}
		return subList;
