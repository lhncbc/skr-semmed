			...
			<html:form action="Summary" method="post" focus="file"
				...
				<table cellspacing="3">
					...
					<tr>
						...
						<td>
							<a href="<html:rewrite page="/html/summarytype.html"/>"  onclick="return popup('<html:rewrite page="/html/summarytype.html"/>')" target="_blank">Summary Type</a>:
						...
						<td>
								<logic:equal name="salient" value="true">
									<input type="checkbox" name="saliency"
										onclick="ShowHide('opt');">More <a href="<html:rewrite page="/html/predication.html"/>"  onclick="return popup('<html:rewrite page="/html/predication.html"/>')" target="_blank">Predications</a>
								</logic:equal>
				...
				<aa:zone name="relevance">
					...
					Select a UMLS concept to <a href="<html:rewrite page="/html/summarization.html"/>" onclick="return popup('<html:rewrite page="/html/summarization.html"/>')" target="_blank">summarize</a> on:<br>
				...
				<div id="">
					...
					<a href="<html:rewrite page="/html/summarization.html"/>" onclick="return popup('<html:rewrite page="/html/summarization.html"/>')" target="_blank">Help</a>
				...
				<html:form action="Visualize" method="post">
					...
					<div id="">
							...
							<a href="<html:rewrite page="/html/HelpVisualize.html"/>" onclick="return popupBig('<html:rewrite page="/html/HelpVisualize.html"/>')" target="_blank">Help</a>
					</div>
					</logic:present>
					<logic:present role="SemMedTester">
								<html:submit property="method">
				...
				<html:form action="Visualize" method="post" focus="file"
					...
					<tr>
						<td colspan ="3">
							<html:file property="uploadGraphFile" />
						</td>
					</tr>
					<tr>
						<td>
								<html:submit property="method">
								<bean:message key="visualize.button.uploadAndVisulize" />
							</html:submit>
						<a href="<html:rewrite page="/html/HelpUploadVisualize.html"/>" onclick="return popupMid('<html:rewrite page="/html/HelpUploadVisualize.html"/>')" target="_blank">Help</a>
						</td>
					</tr>
				  	</table>
				</html:form>
...
// 	 }
	...
	function popup(url) {
		newwindow=window.open(url,'name','height=250,width=350, scrollbars=1, resizable=1, screenX=500, screenY=300');
		if (window.focus) {newwindow.focus()}
		return false;
	}

		function popupMid(url) {
		newwindow=window.open(url,'name','height=500,width=420, scrollbars=1, resizable=1, screenX=500, screenY=300');
		if (window.focus) {newwindow.focus()}
		return false;
	}

	function popupBig(url) {
		newwindow=window.open(url,'name','height=900,width=600, scrollbars=1, resizable=1, screenX=500, screenY=300');
		if (window.focus) {newwindow.focus()}
		return false;
	}
</script>
