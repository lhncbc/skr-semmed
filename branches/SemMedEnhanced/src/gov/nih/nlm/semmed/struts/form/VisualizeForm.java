...
public class VisualizeForm extends ActionForm {
	...
	/** uploadFile property */
	private FormFile uploadGraphFile;
	/** seed property */
	private String seed;
	...
	public ActionErrors validate(
		...
		if ((uploadGraphFile == null || uploadGraphFile.getFileName().trim().length() == 0) &&
	 ...
	 * @return Returns the uploadFile.
	 */
	public FormFile getUploadGraphFile() {
		return uploadGraphFile;
	}

	/**
	 * @param uploadFile The uploadFile to set.
	 */
	public void setUploadGraphFile(FormFile uploadGraphFile) {
		this.uploadGraphFile = uploadGraphFile;
	}
