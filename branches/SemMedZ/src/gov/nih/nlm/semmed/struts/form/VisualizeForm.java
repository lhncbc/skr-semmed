...
public class VisualizeForm extends ActionForm {
	...
	/** uploadFile property */
	private FormFile uploadGraphFileR;

	/** uploadFile property */
	private FormFile uploadGraphFileZ;
	/** seed property */
	private String seed;
	...
	public ActionErrors validate(
		...
		if ((uploadGraphFileR == null || uploadGraphFileR.getFileName().trim().length() == 0) &&
				request.getParameter("method")!=null && request.getParameter("method").equals("Upload And Visualize")) {
				errors.add("uploadGraphFilename", new ActionError("error.uploadfile.required"));
		}
	 ...
	 * @return Returns the uploadFile.
	 */
	public FormFile getUploadGraphFileR() {
		return uploadGraphFileR;
	}

	/**
	 * @param uploadFile The uploadFile to set.
	 */
	public void setUploadGraphFileR(FormFile uploadGraphFileR) {
		this.uploadGraphFileR = uploadGraphFileR;
	}

	/**
	 * @return Returns the uploadFile.
	 */
	public FormFile getUploadGraphFileZ() {
		return uploadGraphFileZ;
	}

	/**
	 * @param uploadFile The uploadFile to set.
	 */
	public void setUploadGraphFileZ(FormFile uploadGraphFileZ) {
		this.uploadGraphFileZ = uploadGraphFileZ;
	}
