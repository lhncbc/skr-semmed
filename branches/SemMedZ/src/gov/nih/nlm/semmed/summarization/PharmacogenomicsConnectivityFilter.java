 ...
 *
 */
public class PharmacogenomicsConnectivityFilter implements Filter {

	private static Log log = LogFactory.getLog(PharmacogenomicsConnectivityFilter.class);
	private static PharmacogenomicsConnectivityFilter myInstance = new PharmacogenomicsConnectivityFilter();

	public static PharmacogenomicsConnectivityFilter getInstance(){
		return myInstance;
	}

	private PharmacogenomicsConnectivityFilter(){}
