	...
	<div id="content">
		<html:form action="Search" method="POST" focus="file" enctype="multipart/form-data">
				...
				<table>
					...
					<tr>
						...
						<td colspan="5" nowrap="nowrap">
							<html:text size="40" property="term" value="<%=term%>" />
						</td>
						<td colspan="1">
							<html:submit property="method">
								<bean:message key="search.button.pubmedsearch" />
							</html:submit>
						</td>
						<!--   <td colspan="1">
							<html:submit property="method">
					...
					<tr>
						...
						<bean:define id="essieterm" name="essiequery" property="term"
							scope="session" type="java.lang.String" />
						<td colspan="3" nowrap="nowrap">
							<html:text size="40" property="essieterm" value="<%=essieterm%>" />
						</td>
						<td colspan="1">
							<html:submit property="method">
								<bean:message key="search.button.essiesearch" />
							</html:submit>
						</td>
						<!--  <td colspan="1">
							<html:submit property="method">
					...
					<tr>
						...
						<logic:present name="essieyear" scope="session">
							<bean:define id="essieyear" name="essieyear"
								scope="session" type="java.lang.String" />
							<td>
								<html:text size="10" property="essieyear" value="<%=essieyear%>" />
							</td>
						</logic:present>
						<logic:notPresent name="essieyear" scope="session">
							<td>
								<html:text size="10" property="essieyear" value="" />
			...
			<logic:present name="displayedCitations" scope="session">
				...
				<logic:equal name="source" value="essie">
					<ul class="tabs" style="margin-left:-10px;">
						<li>
							<span class="left"><strong><a href="javascript:void(null);"><span
								class="center">Essie Citations</span> </a> </strong> </span>
						</li>
					</ul>
				</logic:equal>
				...
				<logic:equal name="source" value="both">
					<ul class="tabs" style="margin-left:-10px">
						...
						<li>
							<% if (session.getAttribute("currentSource").equals("Essie")){%>
							<span class="left"><a href="javascript:void(null);" onclick="tab('Medline')"><span
								class="center" id="medlineTab" style="font-weight:bold">Medline Articles</span> </a> </span>
							<%}else{ %>
								<span class="left"><a href="javascript:void(null);" onclick="tab('Medline')"><span
				...
				<div class="searchResults">
					...
					<div id="<%=sourceName%>">
						...
						+ sourceName + "&p={}"%>" />
							<%
							} else if (session.getAttribute("currentSource").equals("Essie")){
							%>
								<ale:index count="<%=count%>" currentPage="<%=pageNumber%>"
									link="<%="../Search.do;method=essieSearch?method=essieSearch&s="
						+ sourceName + "&p={}"%>" />
							<% } %>
								...
								<table id="pubmed" rules="rows">
									...
									<%
											...
											for (Object o : myCitations) {
												...
												if (sourceName.equals("Medline") || sourceName.equals("Essie")) {
									%>
									<tr>
										<td>
											<a
