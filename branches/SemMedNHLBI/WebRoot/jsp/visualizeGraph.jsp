...
<body>
		<logic:present name="key" scope="session">
			...
			<!--
					...
					var majorVersion = GetMajorVer();
					document.title = document.title.slice(0, 47) + " - Flash Version: " + majorVersion;
					if ( hasProductInstall && !hasRequestedVersion ) {
						...
						AC_FL_RunContent(
							...
							"pluginspage", "http://www.adobe.com/go/getflashplayer"
											...
											// if we've detected Flash version 10
				...
				<noscript>
					...
					id="GraphApp10" width="100%" height="100%"
					codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
					<param name="movie" value="GraphApp10.swf?graphKey=pepe" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#869ca7" />
					<param name="allowScriptAccess" value="sameDomain" />
					<param name='flashvars'
						value="graphKey=<c:out value="<%=graphKey%>"/>" />
					<embed src="GraphApp10.swf" quality="high" bgcolor="#869ca7"
						width="100%" height="100%" name="GraphApp10" align="middle"
