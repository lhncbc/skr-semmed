...
public class SearchForm extends ActionForm {
	...
	/** essieterm property */
	private String essieterm;
	/** essieyear property */
	private String essieyear;
...
/*	public void setSelectedSearchType(String selectedSearchType) {
	 ...
	 * @param search The term to set
	 */
	public void setEssieterm(String essieterm) {
		this.essieterm = essieterm;
	}
	 ...
	 * @param search The term to set
	 */
	public void setEssieyear(String essieyear) {
		this.essieyear = essieyear;
	}
