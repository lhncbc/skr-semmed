 ...
 *
 */
public class EssieArticle extends PubmedArticle
{
	 ...
	 *
	 */
	public EssieArticle(String id, String titleText, String abstractText,
			String author, boolean include)
	{
		this.id = id;
	...
	public EssieArticle(Element e)
	{
		this.id = e.getChild("Citation").getChildTextTrim("PMID");
		Element article = e.getChild("Citation").getChild("Article");
