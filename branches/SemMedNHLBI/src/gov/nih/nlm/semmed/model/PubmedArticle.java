 ...
 *
 */
public class PubmedArticle extends SemMedDocument {
//	private static Log log = LogFactory.getLog(PubmedArticle.class);
	...
	private HashSet<String> metadataList; // extended for accommodating metadata for quality evidence computation by Halil, 11/06/2008
	private String issn;
	private double impactFactor;
	private double qualityEvidence;
	 ...
	 *
	 */
	public PubmedArticle(String id, String titleText, String abstractText, String pubDate, boolean include) {
	...
	public PubmedArticle(Element e) {
		this.id = e.getChild("MedlineCitation").getChildTextTrim("PMID");
		Element article = e.getChild("MedlineCitation").getChild("Article");
		this.titleText = article.getChildTextTrim("ArticleTitle");

		String absText = "";
		try {
			absText = article.getChild("Abstract").getChildTextTrim("AbstractText");
		} catch (Exception le) {
			try {
				absText = e.getChild("MedlineCitation").getChild("OtherAbstract").getChildTextTrim("AbstractText");
			} catch (Exception se) {}
		}
		...
		try {
			pubDateNode = article.getChild("Journal").getChild("JournalIssue").getChild("PubDate");
		} catch (Exception le) {
			try {
	 ...
	 * @param pubDate The pubDate to set.
	 */
	public void setMetadata(HashSet<String> meta) {
	 ...
	 * @return Returns the pubDate.
	 */
	public double getQualityEvidence() {
	 ...
	 * @param pubDate The pubDate to set.
	 */
	public void setQualityEvidence(double qualityEvidence) {
	...
	public boolean equals(Object o){
		...
		return  (id==null? co.id==null: id.equals(co.id)) &&
				(titleText==null? co.titleText==null: titleText.equals(co.titleText)) &&
				(abstractText==null? co.abstractText==null: abstractText.equals(co.abstractText)) &&
				(pubDate==null? co.pubDate==null: pubDate.equals(co.pubDate));
	}
